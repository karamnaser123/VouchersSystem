<?php $__env->startSection('title',trans("Topup Payment")); ?>
<?php $__env->startSection('content'); ?>

    <div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
        <div class="row justify-content-between">
            <div class="col-md-12">
                <form action="<?php echo e(route('admin.topUpSell.search')); ?>" method="get">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <select class="form-control mb-3" name="top_status"
                                ...
                                <option value="0" <?php if(@request()->top_status==0): ?> selected <?php endif; ?>><?php echo app('translator')->get('All Top Up'); ?>
                                </option>
                                <option value="1" <?php if(@request()->top_status==1): ?> selected <?php endif; ?>><?php echo app('translator')->get('Complete Top Up'); ?>
                                </option>
                                <option value="2" <?php if(@request()->top_status==2): ?> selected <?php endif; ?>>
                                    <?php echo app('translator')->get('Pending Top Up'); ?></option>
                            </select>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <table class="categories-show-table table table-hover table-striped table-bordered">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $topUpSell; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td data-label="<?php echo app('translator')->get('Category'); ?>"><?php echo e(@optional($row->category)->details->name); ?></td>
                        <td data-label="<?php echo app('translator')->get('Service'); ?>"><?php echo e(optional($row->service)->name); ?></td>
                        ...
                        <td data-label="<?php echo app('translator')->get('Status'); ?>">
                            ...
                            <td data-label="<?php echo app('translator')->get('More'); ?>">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary btn-icon edit_button"
                                        ...
                                        data-route="<?php echo e(route('admin.topUpSell.action',$row->id)); ?>"
                                        data-feedback="<?php echo e($row->feedback); ?>"
            ...
            <?php echo e($topUpSell->links('partials.pagination')); ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                <div class="modal-header modal-colored-header bg-primary">
                    <h4 class="modal-title" id="myModalLabel"><?php echo app('translator')->get('Top Up Information'); ?></h4>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/admin/sell_summary/topUpSell.blade.php ENDPATH**/ ?>