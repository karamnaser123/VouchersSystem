        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <?php if(config('basic.top_up')): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php if(request()->routeIs('shop') && request()->sortByCategory == 'iptv'): ?> active <?php endif; ?>"
                                href="<?php echo e(route('shop') . '?sortByCategory=iptv'); ?>"><?php echo app('translator')->get('iptv'); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if(config('basic.top_up')): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php if(request()->routeIs('shop') && request()->sortByCategory == 'phone'): ?> active <?php endif; ?>"
                                href="<?php echo e(route('shop') . '?sortByCategory=phone'); ?>"><?php echo app('translator')->get('phone'); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if(config('basic.top_up')): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php if(request()->routeIs('shop') && request()->sortByCategory == 'account'): ?> active <?php endif; ?>"
                                href="<?php echo e(route('shop') . '?sortByCategory=account'); ?>"><?php echo app('translator')->get('account'); ?></a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(menuActive('login')); ?>"
...
<?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/themes/gameshop/layouts/app.blade.php ENDPATH**/ ?>