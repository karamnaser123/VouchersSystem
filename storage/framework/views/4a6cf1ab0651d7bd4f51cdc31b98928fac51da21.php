...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get($giftCardService->name); ?>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card  shadow">
                    <div class="card-body">
                        <h4 class="card-title">`<?php echo app('translator')->get(@optional($giftCardService->giftCard)->details->name); ?>` <?php echo app('translator')->get('Services'); ?></h4>


                        <div class="list-group ">
                            <?php if($giftCardService->giftCard): ?>
                                <?php $__currentLoopData = optional($giftCardService->giftCard)->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('admin.giftCard.serviceCode',[$data->id])); ?>"
                                       class="list-group-item  d-flex justify-content-between <?php if($giftCardService->name == $data->name): ?> active <?php endif; ?>"
                ...
                <div class="card shadow my-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="<?php echo e(route('admin.sampleFiles')); ?>" class="btn btn-sm btn-success btn-rounded"><i class="fa fa-download"></i> <?php echo app('translator')->get('Sample'); ?></a>
                        </div>

                        <form action="<?php echo e(route('admin.uploadBulkGiftCardCode')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                ...
                <div class="card  shadow">
                    ...
                    <div class="card-body">
                        ...
                        <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                            ...
                            <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $giftCardServiceCode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Gift Card'); ?>"><?php echo e($item->giftCard->name); ?></td>
                                    <td data-label="<?php echo app('translator')->get('Service'); ?>"><?php echo e($item->giftCardService->name); ?></td>
                                        ...
                                        <div class="dropdown show dropup">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <button class="dropdown-item edit-button" data-toggle="modal"
                                                        ...
                                                        data-route="<?php echo e(route('admin.giftCardServiceCodeUpdate',$item->id)); ?>"
                                                ...
                                                <a class="dropdown-item deleteBtn notiflix-confirm" href="javascript:void(0)"
                                                   ...
                                                   data-route="<?php echo e(route('admin.giftCardServiceCodeDelete', $item->id)); ?>"
                                                   data-toggle="modal"
                                                >
    ...
    <div class="modal fade" id="add_code" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.giftCardServiceCodeStore',[$giftCardId,$serviceId])); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
        ...
        $(document).ready(function (e) {
            ...
            $(document).on('click', '.active-yes', function (e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('admin.giftCardServiceCode.active')); ?>",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
            ...
            $(document).on('click', '.inactive-yes', function (e) {
                ...
                $.ajax({
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                    url: "<?php echo e(route('admin.giftCardServiceCode.inactive')); ?>",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
            ...
            $(document).on('click', '.delete-yes', function (e) {
                ...
                $.ajax({
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                    url: "<?php echo e(route('admin.giftCardServiceCode.delete')); ?>",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/admin/gift_card/codeList.blade.php ENDPATH**/ ?>