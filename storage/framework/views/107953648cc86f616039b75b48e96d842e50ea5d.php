<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Voucher List'); ?>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-3">
                <div>
                    <a href="<?php echo e(route('admin.gameVoucherCreate')); ?>" class="btn btn-sm btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $manageVoucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                    ...
                                    <div class="dropdown show dropup">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item"
                                                href="<?php echo e(route('admin.gameVoucherEdit', $item->id)); ?>">
                                            ...
                                            <a class="dropdown-item notiflix-confirm" href="javascript:void(0)"
                                                ...
                                                data-route="<?php echo e(route('admin.gameVoucherDelete', $item->id)); ?>"
                                                data-toggle="modal">
    ...
    <div class="modal fade" id="add_service" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.voucherServicesStore')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold"><?php echo app('translator')->get('Voucher'); ?> </label>
                            <select class="form-control" name="voucher_id" aria-label=".form-select-lg example" required>
                                ...
                                <?php $__currentLoopData = $manageVoucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->details->game_vouchers_id); ?>"><?php echo e($item->details->name); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="modal fade" id="all_active" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title"><?php echo app('translator')->get('Voucher Active Confirmation'); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                </div>
                <div class="modal-body">
                    <p><?php echo app('translator')->get('Are you really want to active the Voucher'); ?></p>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="all_inactive" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title"><?php echo app('translator')->get('Voucher DeActive Confirmation'); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                </div>
                <div class="modal-body">
                    <p><?php echo app('translator')->get('Are you really want to Deactive the Voucher'); ?></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light"
                        data-dismiss="modal"><span><?php echo app('translator')->get('No'); ?></span></button>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control service-game_vouchers_id" name="voucher_id" required>
                                <option value="" selected disabled><?php echo app('translator')->get('Select Voucher'); ?></option>
                                <?php $__currentLoopData = $manageVoucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(optional($item->details)->game_vouchers_id); ?>">
    ...
    <script>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a  href="${obj.serviceInfoRoute}" target="_blank"
                                      class="btn btn-sm btn-outline-success"><?php echo app('translator')->get('Voucher Code'); ?></a>
                        </td>
                    </tr>`;
        ...
        $(document).on('click', '.active-yes', function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('admin.gameVoucher.active')); ?>",
                data: {
                    strIds: strIds
                },
                datatType: 'json',
        ...
        $(document).on('click', '.inactive-yes', function(e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('admin.gameVoucher.inactive')); ?>",
                data: {
                    strIds: strIds
                },
                datatType: 'json',
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/admin/game_voucher/voucherList.blade.php ENDPATH**/ ?>