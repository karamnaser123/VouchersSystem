<?php $__env->startSection('title', trans('Voucher Details')); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 pe-lg-5 mb-5 mb-md-0">
                    <div class="img-box">
                        <img class="img-fluid" src="<?php echo e(getFile(config('location.voucher.path') . @$voucherDetails->image)); ?>"
                            alt="..." />
                    </div>
                    <div class="text-box">
                        <h4><?php echo app('translator')->get(@$voucherDetails->details->name); ?></h4>
                        <p>
                            <?php echo app('translator')->get(@$voucherDetails->details->details); ?>
                        </p>
                    </div>
                </div>
                <div class="col-lg-8 col-md-6">
                    <form action="<?php echo e(route('user.voucher.payment')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <!-- SELECT RECHARGE -->
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="d-flex flex-wrap  justify-content-start ">
                                <?php $__empty_1 = true; $__currentLoopData = $voucherDetails->activeServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php if(0 < count($item->voucherActiveCodes)): ?>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function checkCalc(serviceId, gatewayId) {
            ...
            $('#loading').show();
            $.ajax({
                url: "<?php echo e(route('ajaxCheckVoucherCalc')); ?>",
                type: 'POST',
                data: {
                    serviceId,
                    gatewayId
...
<?php echo $__env->make($theme . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/themes/gameshop/voucher-details.blade.php ENDPATH**/ ?>