        ...
        <script>
            function submitForm() {
                if (confirm('هل أنت متأكد من رغبتك في الشحن؟')) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('showPlayerData')); ?>',
                        data: requestData,
...
<?php echo $__env->make($theme . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/topupfreefire.blade.php ENDPATH**/ ?>