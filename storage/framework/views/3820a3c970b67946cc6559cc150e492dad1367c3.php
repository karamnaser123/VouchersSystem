            ...
            <div class="col-md-6 col-lg-3">
                <div class="footer-box">
                    ...
                    <a class="navbar-brand" href="#">
                        <img style="width: 100px" src="<?php echo e(asset('storage/image/logo.png')); ?>" alt="Your Image Alt Text">
                    </a>
                ...
                <div class="footer-box">
                    ...
                    <form action="<?php echo e(route('subscribe')); ?>" method="post">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" name="email" class="form-control" placeholder="<?php echo app('translator')->get('Enter Email'); ?>"
                                aria-label="Subscribe Newsletter" aria-describedby="basic-addon" />
                            <span class="input-group-text" id="basic-addon"><button type="submit"><img
                                        src="<?php echo e(asset($themeTrue . '/images/icon/paper-plane.png')); ?>"
                                        alt="..." /></button>
                            </span>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="social-links mt-2">
                            <?php $__currentLoopData = $contentDetails['social']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(@$data->content->contentMedia->description->link); ?>"
                                    title="<?php echo app('translator')->get($data->description->name); ?>">
        ...
        <div class="footer-bottom">
            <div class="row">
                <div class="col-md-6">
                    <p class="copyright">
                        <?php echo app('translator')->get('Copyright © 2024'); ?> <a href="<?php echo e(route('home')); ?>">Anticrash</a>
                        <?php echo app('translator')->get('All Rights Reserved'); ?>
                        <!--<?php echo app('translator')->get($basic->site_title); ?>-->
                    </p>
                </div>
...
<?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/themes/gameshop/partials/footer.blade.php ENDPATH**/ ?>