                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-list ">
                            ...
                            <?php if(config('basic.top_up')): ?>
                                <a href="<?php echo e(route('admin.topUpSell',$user->id)); ?>"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-gamepad"></i></span> <?php echo app('translator')->get('Game Topup'); ?>
                                </a>
                            <?php endif; ?>
                            <?php if(config('basic.voucher')): ?>
                                <a href="<?php echo e(route('admin.voucherSell',$user->id)); ?>"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-tags"></i></span> <?php echo app('translator')->get('Voucher Sell'); ?>
                                </a>
                            <?php endif; ?>
                            <?php if(config('basic.gift_card')): ?>
                                <a href="<?php echo e(route('admin.sellGiftCard',$user->id)); ?>"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fab fa-cc-apple-pay"></i></span> <?php echo app('translator')->get('Gift Card Sell'); ?>
                                </a>
                            <?php endif; ?>
                            <?php if(config('basic.sell_post')): ?>
                                <a href="<?php echo e(route('admin.gameSellList',['user',$user->id])); ?>"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-shopping-cart"></i></span> <?php echo app('translator')->get('Sell Post'); ?>
                                </a>

                                <a href="<?php echo e(route('admin.sellOffer',$user->id)); ?>"
                                   class="btn btn-info btn-sm">
                                    <span class="btn-label"><i
                                            class="fas fa-comment-dots"></i></span> <?php echo app('translator')->get('Offer List'); ?>
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/admin/users/edit-user.blade.php ENDPATH**/ ?>