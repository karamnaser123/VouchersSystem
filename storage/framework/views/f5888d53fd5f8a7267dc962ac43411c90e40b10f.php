                    ...
                    <div class="custom-card card-lg bg-gradient">
                        <div class="card-body gradient-bg profile">
                            <ul class="nav nav-tabs d-flex flex-wrap" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e($errors->has('password') ? 'active' : ''); ?>" data-bs-toggle="tab"
                                    ...
                                    <div class="contact-box">
                                        <form action="<?php echo e(route('user.updateInformation')); ?>" method="post">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-4">
                                                        <label class="form-label"><?php echo app('translator')->get('Preferred language'); ?></label>
                                                        ...
                                                        <div style="color: white" class="col-md-6 language form-control">
                                                            <?php $__empty_1 = true; $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                <a
                                                                    href="<?php echo e(route('language', $lang->short_name)); ?>"><?php echo e(trans($lang->name)); ?></a>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <textarea class="form-control" name="address" rows="5"><?php echo app('translator')->get($user->address); ?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="identity_type" id="identity_type"
                                                    ...
                                                    <?php $__currentLoopData = $identityFormList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sForm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($sForm->slug); ?>"
                                                            <?php echo e(old('identity_type', @$identity_type) == $sForm->slug ? 'selected' : ''); ?>>
                                                            <?php echo app('translator')->get($sForm->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if(isset($identityForm)): ?>
                                                <?php $__currentLoopData = $identityForm->services_form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($v->type == 'text'): ?>
                                                        <div class="form-group">
                                                            <label for="<?php echo e($k); ?>"><?php echo e(trans($v->field_level)); ?>
                                                    ...
                                                    <?php elseif($v->type == 'textarea'): ?>
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="<?php echo e($k); ?>" id="<?php echo e($k); ?>" class="form-control form--control style--two"
                                                                rows="5" placeholder="<?php echo e(trans('Type Here')); ?>" <?php if($v->validation == 'required'): ?>  <?php endif; ?>><?php echo e(old($k)); ?></textarea>
                                                            <?php $__errorArgs = [$k];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                                                ...
                                                                <div class="img-input-div">
                                                                    <span class="btn btn-success btn-file">
                                                                        <span class="fileinput-new "> <?php echo app('translator')->get('Select'); ?>
                                                                            <?php echo e($v->field_level); ?></span>
                                                                        <span class="fileinput-exists">
                                                                            <?php echo app('translator')->get('Change'); ?></span>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit"
                                                        class="game-btn w-100"><?php echo app('translator')->get('Submit'); ?></button>
                                                </div>
                                            <?php endif; ?>
                                        </form>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="game-btn w-100"><?php echo app('translator')->get('Submit'); ?></button>
                                            </div>
                                        </form>
...
<?php echo $__env->make($theme . 'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gameemif/vouchersystem.gamebrio.store/resources/views/themes/gameshop/user/profile/myprofile.blade.php ENDPATH**/ ?>