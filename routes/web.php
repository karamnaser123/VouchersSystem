...
Route::group(['middleware' => ['auth']], function () {
    Route::get('/topupfreefire', [TopUpController::class, 'show'])
        ->name('showfreefire');
    Route::post('/topupfreefire', [TopUpController::class, 'showPlayerData'])->name('showPlayerData');
});
...
Route::get('/', function () {
    return redirect('/shop?sortByCategory=topUp');
})->name('home');
...
Route::get('pubgvoucher', function () {
    return view('pubgvoucher');
})->name('pubgvoucher');