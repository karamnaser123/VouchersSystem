    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-3">
                <div class="footer-box">
                    ...
                    <a class="navbar-brand" href="#">
                        <img style="width: 100px" src="{{ asset('storage/image/logo.png') }}" alt="Your Image Alt Text">
                    </a>
                    ...
                    <form action="{{ route('subscribe') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <span class="input-group-text" id="basic-addon"><button type="submit"><img
                                        src="{{ asset($themeTrue . '/images/icon/paper-plane.png') }}"
                                        alt="..." /></button>
                            </span>
                        </div>
                        ...
                        <div class="social-links mt-2">
                            @foreach ($contentDetails['social'] as $data)
                                <a href="{{ @$data->content->contentMedia->description->link }}"
                                    title="@lang($data->description->name)">
        ...
        <div class="footer-bottom">
            <div class="row">
                <div class="col-md-6">
                    <p class="copyright">
                        @lang('Copyright © 2024') <a href="{{ route('home') }}">Anticrash</a>
                        @lang('All Rights Reserved')
                        <!--@lang($basic->site_title)-->
                    </p>
                </div>
