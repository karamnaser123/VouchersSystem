        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 pe-lg-5 mb-5 mb-md-0">
                    <div class="img-box">
                        <img class="img-fluid" src="{{ getFile(config('location.voucher.path') . @$voucherDetails->image) }}"
                            alt="..." />
                    </div>
                    <div class="text-box">
                                    ...
                                    @if (0 < count($item->voucherActiveCodes))
                                        <div class="m-1 package-list ">
                                            <input type="radio" class="btn-check recharge-check" name="service"
                                                value="{{ $item->id }}" id="option{{ $item->id }}"
                                                autocomplete="off">
                                ...
                                <div class="d-flex flex-wrap justify-content-start ">
                                    ...
                                    <div class="m-1 package-list gateway">
                                        ...
                                        <label class="btn btn-primary" for="gateway0">
                                            <img class="img-fluid" src="{{ asset($themeTrue . 'images/icon/wallet1.png') }}"
