                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title"
                                            value="{{ $sellPost->title }}" id="exampleFormControlInput1" placeholder="Title"
                                            required />
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="form-group header-box-title">
                                        ...
                                        <div class="input-group append">
                                            <input type="text" class="form-control price" name="price"
                                                value="{{ old('price', $sellPost->price) }}" id="exampleFormControlInput1"
                                                        ...
                                                        @if ($v->type == 'text')
                                                            <div class="form-group">
                                                                <label for="exampleFormControlInput1"
                                                                    class="form-label">{{ trans($v->field_name) }}
                                ...
                                <div class="col-md-12 mb-5">
                                    ...
                                    <textarea class="form-control" name="details" id="exampleFormControlTextarea1" rows="5"
                                        placeholder="Description" required>{{ $sellPost->details }}</textarea>
                                        ...
                                        @for ($i = 0; $i < count($sellPost->image); $i++)
                                            <div class="col-sm-12 col-md-4 image-column d-block">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <button class="btn btn-danger notiflix-confirm removeFile z9"
