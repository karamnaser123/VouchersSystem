                        ...
                        <form action="{{ route('user.sellStore') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 mb-5">
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlInput1" class="form-label">@lang('category')
                                    </label>
                                    <select class="form-select" name="category" id="category"
                                        ...
                                        @foreach ($categoryList as $item)
                                            <option value="{{ $item->id }}"
                                                @if (@$category->id == $item->id) selected @endif>@lang(@optional($item->details)->name)</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1" class="form-label">@lang('Title')
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group header-box-title">
                                        <label for="exampleFormControlInput1" class="form-label">@lang('Price')
                                        </label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group append">
                                                    <input type="text" class="form-control price" name="price"
                                                        value="{{ old('price') }}" id="exampleFormControlInput1"
                                                ...
                                                @if ($errors->has('price'))
                                                    <div class="error text-danger">@lang($errors->first('price'))
                                                    </div>
                                                @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        @elseif($v->type == 'textarea')
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="{{ $k }}" class="form-control" @if ($v->validation == 'required')  @endif>{{ old($k) }}</textarea>
                                                                @if ($errors->has($k))
                                                                    <span
                                ...
                                <div class="col-md-12 mb-4 mb-5">
                                    ...
                                    <textarea class="form-control" name="details" id="exampleFormControlTextarea1" rows="5"
                                        placeholder="@lang('Description')">{{ old('details') }}</textarea>
                                    @if ($errors->has('details'))
                                        <div class="error text-danger">@lang($errors->first('details')) </div>
                                    @endif
                                </div>
                                <div class="col-md-12 mb-5">
                                    <label for="exampleFormControlTextarea1" class="form-label">@lang('Message to the Reviewer')</label>
                                    <textarea class="form-control" name="comments" id="exampleFormControlTextarea1" rows="2"
                                        placeholder="@lang('comment')">{{ old('comments') }}</textarea>
                                    @if ($errors->has('comments'))
                                        <div class="error text-danger">@lang($errors->first('comments')) </div>
                                    @endif
                                </div>
