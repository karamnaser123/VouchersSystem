 ...
 --}}
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="dashboard__card dashboard__card-1">
                            <div class="dashboard__card-content">
                                <h2 class="price">
                                    <sup>{{ config('basic.currency_symbol') }}</sup>{{ $upcoming['upComingAmount'] }}
                                </h2>
                                    ...
                                    <tbody>
                                        @forelse($paymentLog as $key=>$item)
                                            <tr>
                                                ...
                                                <td data-label="@lang('Amount')">{{ config('basic.currency_symbol') }}
                                                    {{ getAmount($item->sellPostPayment->price) }}</td>
