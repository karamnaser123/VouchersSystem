            ...
            <div class="row">
                            ...
                            <form action="" method="get">
                                <div class="input-group">
                                    <input type="text" name="search" value="{{ old('search', request()->search) }}"
                                        class="form-control" placeholder="@lang('Search items')"
                            ...
                            <form action="" method="get" id="sortByCategory">
                                <div class="check-box">
                                    @if (config('basic.top_up'))
                                        <div class="form-check mb-3">
                                            <input name="sortByCategory" class="form-check-input" type="checkbox"
                                                value="topUp" @if (isset(request()->sortByCategory) && in_array('topUp', explode(',', request()->sortByCategory))) checked @endif
                                                id="check1" />
                                    ...
                                    @if (config('basic.voucher'))
                                        <div class="form-check mb-3">
                                            <input name="sortByCategory" class="form-check-input" type="checkbox"
                                                value="voucher" @if (isset(request()->sortByCategory) && in_array('voucher', explode(',', request()->sortByCategory))) checked @endif
                                                id="check2" />
                                    ...
                                    @if (config('basic.gift_card'))
                                        <div class="form-check">
                                            <input name="sortByCategory" class="form-check-input" type="checkbox"
                                                value="giftCard" @if (isset(request()->sortByCategory) && in_array('giftCard', explode(',', request()->sortByCategory))) checked @endif
                                                id="check3" />
                ...
                <div class="col-lg-8 mt-5 mt-lg-0">
                    <div class="item-area">
                        ...
                        <div class="row g-4">
                                            @if (request()->sortByCategory == 'topUp')
                                <!-- The following section will only be displayed when sortByCategory is topUp -->
                                <div class="col-md-3 col-sm-4 col-4">
                                    <a href="{{ route('showfreefire') }}" class="text-white">
                                        <div class="img-box">
                                            <img src="{{ asset('storage/image/freefire4.png') }}" alt="فري فاير شحن مباشر"
                                                title="فري فاير شحن مباشر" class="img-fluid">
                                            <div class="tags"><span>6%</span></div>
                                            <p class="pt-2 mb-0">
                                                {{ \Illuminate\Support\Str::limit('فري فاير شحن مباشر', 17) }}
                                            </p>
                                        </div>
                                    </a>
                                </div>
                            ...
                            @forelse($items as $key => $item)
                                <div class="col-md-3 col-sm-4 col-4">
                                    <a href="{{ $item->detailsRoute }}" class="text-white">
                                        <div class="img-box">
                                            <img src="{{ $item->imgPath }}" alt="{{ optional($item->details)->name }}"
