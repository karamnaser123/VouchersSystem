        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 pe-md-5 mb-5 mb-md-0">
                    <h2>@lang('Contact')</h2>
                    <p>
                        @lang('Want to make a purchase or need any help to find the best solutions for you? Feel free to contact us. Below are our contacts details')
                    </p>
                    <div class="mt-5">
                ...
                <div class="col-md-6">
                    <div class="contact-box">
                        <form action="{{ route('contact.send') }}" method="post">
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">@lang('Type your message')</label>
