        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 pe-lg-5 mb-5 mb-md-0">
                    <div class="img-box">
                        <img class="img-fluid" src="{{ getFile(config('location.category.path') . @$topUpDetails->image) }}"
                            alt="..." />
                    </div>
                    <div class="text-box">
                        ...
                        {{-- @if ($topUpDetails->appStoreLink)
                            <a href="{{ $topUpDetails->appStoreLink }}">
                                <img class="img-fluid" src="{{ asset($themeTrue) . '/images/app.png' }}" alt="..." />
                            </a>
                        @endif --}}
                    </div>
                </div>
                                        ...
                                        @foreach ($topUpDetails->form_field as $k => $v)
                                            @if ($v->type == 'text')
                                                <div>
                                                    ...
                                                    @if ($errors->has($k))
                                                        <br><span class="text-danger">{{ trans($errors->first($k)) }}</span>
                                                    @endif
                                                </div>
                                    ...
                                    @forelse($topUpDetails->activeServices as $key => $item)
                                        <div class="m-1 package-list ">
                                            <input type="radio" class="btn-check recharge-check" name="service" required
                                                ...
                                                value="{{ $item->id }}"
                                                @if (old('service') == $item->id) checked @endif
                                ...
                                <div class="d-flex flex-wrap justify-content-start ">
                                    <div class="m-1 package-list gateway">
                                        <input type="radio" class="btn-check gateway-check" name="gateway" required
                                            id="gateway0" value="0" @if (old('gateway') == '0') checked @endif
                                            autocomplete="off" />
                                    ...
                                    @foreach ($gateways as $gateway)
                                        <div class="m-1 package-list gateway">
                                            <input type="radio" class="btn-check gateway-check" name="gateway" required
                                                ...
                                                @if (old('gateway') == $gateway->id) checked @endif autocomplete="off" />
