...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="{{ url('/shop?sortByCategory=voucher') }}">
                <img style="width: 150px" src="{{ asset('storage/image/logo.png') }}" alt="Your Image Alt Text">
            </a>
            @auth
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('user.home') }}"><img class="me-2"
                                            src="{{ asset($themeTrue . '/images/icon/block.png') }}" alt="..." />
                                        @lang('Dashboard')</a>
                                </li>
                                <li>
                                    <a href="{{ route('user.profile') }}"><img class="me-2"
                                            src="{{ asset($themeTrue . '/images/icon/editing.png') }}" alt="..." />
                                        @lang('My Profile')</a>
                                </li>
                                <li>
                                    <a href="{{ route('logout') }}"
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link {{ menuActive('about') }}"
                            href="{{ route('about') }}">@lang('About Us')</a>
                    </li> --}}

                    {{-- 
                    <li class="nav-item">
                        <a class="nav-link {{ menuActive('showPlayerData') }}"
                            href="{{ route('showPlayerData') }}">@lang('topupfreefire')</a>
                    </li> --}}
                    ...
                    @if (config('basic.top_up'))
                        <li class="nav-item">
                            <a class="nav-link @if (request()->routeIs('shop') && request()->sortByCategory == 'iptv') active @endif"
                                href="{{ route('shop') . '?sortByCategory=iptv' }}">@lang('iptv')</a>
                        </li>
                    @endif
                    @if (config('basic.top_up'))
                        <li class="nav-item">
                            <a class="nav-link @if (request()->routeIs('shop') && request()->sortByCategory == 'phone') active @endif"
                                href="{{ route('shop') . '?sortByCategory=phone' }}">@lang('phone')</a>
                        </li>
                    @endif
                    @if (config('basic.top_up'))
                        <li class="nav-item">
                            <a class="nav-link @if (request()->routeIs('shop') && request()->sortByCategory == 'account') active @endif"
                                href="{{ route('shop') . '?sortByCategory=account' }}">@lang('account')</a>
                        </li>
                    @endif
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link {{ menuActive('pubgvoucher') }}" target="_blank"
                            href="{{ route('pubgvoucher') }}">@lang('pubgvoucher')</a>
                    </li> --}}


                    {{-- @if (config('basic.sell_post'))
                        <li class="nav-item">
                            <a class="nav-link {{ menuActive('buy') }}"
                                href="{{ route('buy') }}">@lang('BUY ID')</a>
                        </li>
                    @endif --}}
                    ...
                    @guest
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ menuActive('login') }}"
