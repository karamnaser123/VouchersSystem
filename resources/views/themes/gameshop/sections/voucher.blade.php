@if (0 < count($vouchers))
    ...
    <section id="voucher" class="voucher-section">
        <div class="container">
            ...
            <div class="row" data-aos-duration="800" data-aos="zoom-out" data-aos-anchor-placement="center-bottom">
                @forelse($vouchers as $key => $item)
                    <div class="col-lg-2 col-md-3 col-sm-4 col-4">
                        <div class="img-box">
                            <a href="{{ route('voucher.details', [slug(@$item->details->name), $item->id]) }}">
                                <img src="{{ getFile(config('location.voucher.path') . @$item->thumb) }}" alt="..."
